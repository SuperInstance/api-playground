...
<div class="hero"><h1>API Playground</h1>
<p class="subtitle">Interactive API playground for testing fleet endpoints. Build requests, view responses, share.</p></div>
<div class="features">
<div class="card"><h3>Request Builder</h3><p>Construct HTTP requests with headers, body, and method selection.</p></div>
<div class="card"><h3>Response Viewer</h3><p>Formatted JSON/HTML response display with status codes.</p></div>
<div class="card"><h3>Shareable Requests</h3><p>Generate shareable URLs for any API test configuration.</p></div>
<div class="card"><h3>History</h3><p>Full request history with replay capability.</p></div>
</div>
<div class="endpoints">
<h3 style="color:#f59e0b;margin-bottom:1rem">API Endpoints</h3>
<div class="ep">GET / - Interactive playground UI</div>
<div class="ep">GET /api/endpoints - Fleet endpoint catalog</div>
<div class="ep">POST /api/test - Execute test request</div>
